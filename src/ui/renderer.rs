...
impl Renderer {
    ...
    ///
    /// If the context is made current after calling this function, it will
    /// latch the surface to this size until the next buffer swap. Prefer
    /// using [`Self::draw`] unless you know what you're doing.

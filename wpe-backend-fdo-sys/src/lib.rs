...
fn bindgen_test_layout_wpe_view_backend_exportable_fdo_egl_client() {
    ...
    assert_eq!(
        ...
        40usize,
        concat!("Size of: ", stringify!(wpe_view_backend_exportable_fdo_egl_client))
    );
    assert_eq!(
        ::std::mem::align_of::<wpe_view_backend_exportable_fdo_egl_client>(),
        8usize,
        concat!("Alignment of ", stringify!(wpe_view_backend_exportable_fdo_egl_client))
    );
    assert_eq!(
...
fn bindgen_test_layout_wpe_view_backend_exportable_fdo_dmabuf_resource() {
    ...
    assert_eq!(
        ...
        104usize,
        concat!("Size of: ", stringify!(wpe_view_backend_exportable_fdo_dmabuf_resource))
    );
    assert_eq!(
        ::std::mem::align_of::<wpe_view_backend_exportable_fdo_dmabuf_resource>(),
        8usize,
        concat!("Alignment of ", stringify!(wpe_view_backend_exportable_fdo_dmabuf_resource))
    );
    assert_eq!(
...
fn bindgen_test_layout_wpe_view_backend_exportable_fdo_client() {
    ...
    assert_eq!(
        ...
        40usize,
        concat!("Size of: ", stringify!(wpe_view_backend_exportable_fdo_client))
    );
    assert_eq!(
        ::std::mem::align_of::<wpe_view_backend_exportable_fdo_client>(),
        8usize,
        concat!("Alignment of ", stringify!(wpe_view_backend_exportable_fdo_client))
    );
    assert_eq!(

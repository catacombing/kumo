...
pub trait ContextExt: IsA<Context> + sealed::Sealed + 'static {
    ...
    // fn register_class(&self, name: &str, parent_class: Option<&Class>, vtable:
    // /*Ignored*/Option<&mut ClassVTable>) -> Option<Class> {    unsafe { TODO:
    // call ffi:jsc_context_register_class() }
    //}
    ...
    // fn throw_with_name_printf(&self, error_name: &str, format: &str, : /*Unknown
    // conversion*//*Unimplemented*/Basic: VarArgs) {    unsafe { TODO: call
    // ffi:jsc_context_throw_with_name_printf() }
    //}
}

...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("WebKitFaviconClass", Layout {
        size: size_of::<WebKitFaviconClass>(),
        alignment: align_of::<WebKitFaviconClass>(),
    }),
    ...
    ("WebKitImageClass", Layout {
        size: size_of::<WebKitImageClass>(),
        alignment: align_of::<WebKitImageClass>(),
    }),
    ...
    ("WebKitWebExtensionClass", Layout {
        size: size_of::<WebKitWebExtensionClass>(),
        alignment: align_of::<WebKitWebExtensionClass>(),
    }),
    ("WebKitWebExtensionError", Layout {
        size: size_of::<WebKitWebExtensionError>(),
        alignment: align_of::<WebKitWebExtensionError>(),
    }),
    ("WebKitWebExtensionMatchPatternError", Layout {
        size: size_of::<WebKitWebExtensionMatchPatternError>(),
        alignment: align_of::<WebKitWebExtensionMatchPatternError>(),
    }),
    ("WebKitWebExtensionMatchPatternOptions", Layout {
    ...
    ("WebKitXRPermissionRequestClass", Layout {
        size: size_of::<WebKitXRPermissionRequestClass>(),
        alignment: align_of::<WebKitXRPermissionRequestClass>(),
    }),
    ("WebKitXRSessionFeatures", Layout {
        size: size_of::<WebKitXRSessionFeatures>(),
        alignment: align_of::<WebKitXRSessionFeatures>(),
    }),
    ("WebKitXRSessionMode", Layout {
        size: size_of::<WebKitXRSessionMode>(),
        alignment: align_of::<WebKitXRSessionMode>(),
    }),
];
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_ARCHIVE", "807"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_BACKGROUND_PERSISTENCE", "806"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_DECLARATIVE_NET_REQUEST_ENTRY", "805"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST", "802"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST_ENTRY", "804"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_RESOURCE_CODE_SIGNATURE", "801"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_RESOURCE_NOT_FOUND", "800"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_UNKNOWN", "899"),
    ("(gint) WEBKIT_WEB_EXTENSION_ERROR_UNSUPPORTED_MANIFEST_VERSION", "803"),
    ("(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_HOST", "809"),
    ("(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_PATH", "810"),
    ("(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_SCHEME", "808"),
    ("(gint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_UNKNOWN", "899"),
    ("(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_PATHS", "4"),
    ("(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_IGNORE_SCHEMES", "2"),
    ("(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_MATCH_BIDIRECTIONALLY", "8"),
    ("(guint) WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_NONE", "1"),
    ...
    ("(guint) WEBKIT_XR_SESSION_FEATURES_BOUNDED_FLOOR", "8"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_HAND_TRACKING", "32"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_HIT_TEST", "64"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_LAYERS", "128"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_LOCAL", "2"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_LOCAL_FLOOR", "4"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_UNBOUNDED", "16"),
    ("(guint) WEBKIT_XR_SESSION_FEATURES_VIEWER", "1"),
    ("(gint) WEBKIT_XR_SESSION_MODE_IMMERSIVE_AR", "2"),
    ("(gint) WEBKIT_XR_SESSION_MODE_IMMERSIVE_VR", "1"),
    ("(gint) WEBKIT_XR_SESSION_MODE_INLINE", "0"),
];

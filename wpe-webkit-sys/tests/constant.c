...
int main() {
    ...
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_ARCHIVE);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_BACKGROUND_PERSISTENCE);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_DECLARATIVE_NET_REQUEST_ENTRY);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST_ENTRY);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_INVALID_RESOURCE_CODE_SIGNATURE);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_RESOURCE_NOT_FOUND);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_UNKNOWN);
    PRINT_CONSTANT((gint) WEBKIT_WEB_EXTENSION_ERROR_UNSUPPORTED_MANIFEST_VERSION);
    ...
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_BOUNDED_FLOOR);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_HAND_TRACKING);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_HIT_TEST);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_LAYERS);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_LOCAL);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_LOCAL_FLOOR);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_UNBOUNDED);
    PRINT_CONSTANT((guint) WEBKIT_XR_SESSION_FEATURES_VIEWER);
    PRINT_CONSTANT((gint) WEBKIT_XR_SESSION_MODE_IMMERSIVE_AR);
    PRINT_CONSTANT((gint) WEBKIT_XR_SESSION_MODE_IMMERSIVE_VR);
    PRINT_CONSTANT((gint) WEBKIT_XR_SESSION_MODE_INLINE);
    return 0;
}
